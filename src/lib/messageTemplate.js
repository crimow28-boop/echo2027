...
export const MESSAGE_KINDS = [
  ...
  {
    id: "missed",
    label: "שיחה שלא נענתה",
    description: "נשלחת לשיחות ללא מענה — בלי קישור להקלטה",
    defaultBody: DEFAULT_MISSED_TEMPLATE,
    tokens: BASE_TOKENS,
    sample: { callDate: new Date().toISOString(), duration: 0 }
  }
];
...
export function messageKindFor(recording) {
  return isMissedCall(recording) ? "missed" : "recording";
}
